...
export const FeaturedPropertiesPage = () => {
  ...
  const handleFeaturedChange = async (property, featured) => {
    setError("");
    setNotice("");
    setBusyPropertyId(property.id);

    try {
      await setPropertyFeatured(property.id, featured);

      setNotice(
        featured
          ? `${property.code} added to Featured Properties`
          : `${property.code} removed from Featured Properties`,
      );
    ...
    <div className="stack">
      <section className="page-heading row-between">
        <div>
          ...
          <p className="muted">
            Control which public properties are highlighted as featured listings.
          </p>
        </div>
      ...
      <section className="panel filters">
        ...
        >
          ...
          <option value="available">Available to feature</option>
            ...
            <table className="property-table">
              ...
              <tbody>
                {properties.map((property) => {
                  ...
                  const canFeature = property.isPublic;
                  ...
                  return (
                    <tr key={property.id}>
                      ...
                      <td>{formatLocation(property.location)}</td>
                        ...
                        >
                          {property.featured ? (
                            <button
                              ...
                              disabled={isBusy}
                              onClick={() =>
                                handleFeaturedChange(property, false)
                              }
                            >
                            ...
                            <button
                              ...
                              title={
                                canFeature
                                  ...
                                  : "Publish this property before featuring it"
                              }
                              onClick={() =>
                                handleFeaturedChange(property, true)
                              }
                            >
                              {isBusy
                                ? "Updating..."
